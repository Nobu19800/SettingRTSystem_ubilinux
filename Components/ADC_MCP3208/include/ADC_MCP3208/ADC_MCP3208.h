  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  ADC_MCP3208(RTC::Manager* manager);
 ...
 protected:
  ...
  int m_cs_pin;
  /*!
   * A/D変換した電圧値を取得するMCP3208のチャンネル番号
   * 複数指定する場合は”,”で区切ってください。
 ...
 private:
	...
	mraa::Spi* _spi;
	i2c_smf *_smf;
	std::vector<ADC_MCP3208Comp *> adc_ports;
...
{
public:
	ADC_MCP3208Comp(ADC_MCP3208 *rtc, int num);
	~ADC_MCP3208Comp();
	void setActive(bool a);
	void writeValue(MCP3208 *mcp,double v);
	TimedDouble *Out;
...
extern "C"
{
  DLL_EXPORT void ADC_MCP3208Init(RTC::Manager* manager);
};
